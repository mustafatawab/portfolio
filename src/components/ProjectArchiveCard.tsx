...
const ProjectArchiveCard = ({ project, index }: ProjectArchiveCardProps) => {
  return (
    <motion.div
      ...
      className="group flex flex-col h-full rounded-[1.5rem] overflow-hidden border border-border bg-foreground/5 hover:border-neon-cyan/20 transition-all duration-500"
    >
