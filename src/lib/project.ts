...
export const projects: ProjectType[] = [
    {
        ...
        slug: "maktab-one",
        description:
            "Maktab One is a `School Management System` for those mid level schools who has to manage students fees and expenses easily in automatic way. You can check https://www.maktabone.org ",
        githubLink: "",
        ...
        problem:
            "Mid-level schools in Pakistan rely on manual fee tracking and paper-based expense management, leading to frequent accounting errors, lost records, and hours of administrative overhead each week.",
        solution:
            "Built a comprehensive school management platform that automates fee collection, expense tracking, and student record management with role-based access for admin, teachers, and accountants.",
        results: [
...

    {
        ...
        problem:
            "Pharmacies struggle with fragmented inventory management, leading to stockouts of critical medications, expired stock losses, and inefficient point-of-sale operations.",
        solution:
            "Built a multi-tenant pharmacy management platform with centralized inventory tracking, expiry monitoring, supplier management, and an integrated POS system.",
        results: [
...

    {
        ...
        slug: "triton",
        description:
            "TritonCG is a large-scale web ecosystem powered by a robust CMS built with Pyload CMS. The platform is designed to manage and maintain a network of client websites efficiently, offering scalability, reliability, and seamless content management. TritonCG showcases the power of building a scalable CMS-driven ecosystem where dozens of live websites can be managed and updated efficiently. This project highlights my expertise in developing enterprise-grade solutions with a strong focus on scalability, maintainability, and client satisfaction.",
        githubLink: "",
        tags: ["tailwind css", "nextjs", "Payload CMS", "typescript", "node"],
        more: [
            "https://www.rollingvranchwcid1.com/",
            "https://www.rollingvranchwcid2.com/",
            "https://www.rollingvranchwcid3.com/",
            "https://www.rollingvranchwcid5.com/",
            "https://www.palomacreek.org/",
            "https://www.mud222.org/",
        ],
        link: "https://www.tritoncg.com/",
        category: "Websites",
        problem:
            "Managing a growing portfolio of client websites independently was becoming unsustainable - updates were duplicated, branding inconsistent, and maintenance costs were climbing.",
        solution:
            "Architected a centralized CMS ecosystem using Payload CMS that powers and manages multiple client websites from a single administration panel, enabling consistent branding and efficient updates.",
        results: [
    ...
    },
    {
        ...
        description:
            "A landing page which is a portfolio website for a game designer  with a background in computer science and professional experience in game development and user experience and interface",
        ...
        category: "Websites",
        problem:
            "A game designer with a computer science background needed a portfolio that bridges their technical expertise with their creative game design work.",
        solution:
            "Built a visually rich landing page that presents game design projects alongside technical capabilities in a cohesive, engaging layout.",
        results: [
    ...
    },
    {
        ...
        slug: "mal-blogs",
        description:
            "MAL-Blogs is a minimalistic personal blog platform where I share my development journey, technical insights, and experiments with modern tools and frameworks. Built with a clean, distraction-free design, it allows me to focus on creating and publishing content using Markdown/MDX while providing readers with a smooth reading experience.",
        tags: ["tailwind css", "nextjs", "typescript", "Contentfull"],
        githubLink:
            "https://github.com/mustafatawab/Nextjs_projects/tree/main/mal-blogs",
        link: "https://mal-blogs.vercel.app",
        category: "Websites",
        problem:
            "Blogging platforms like Medium and WordPress are cluttered with distractions, ads, and complex editors - neither the writer nor the reader gets a clean experience.",
        solution:
            "Built a minimalistic, distraction-free blog platform with MDX support, syntax highlighting, and a razor focus on reading experience and content creation.",
        results: [
...

    {
        ...
        slug: "msp-tech-stack",
        description:
            "The app is Business to Business marketplace. It has user login system and company login system.",
        tags: [
            "nextjs",
            "typescript",
            "mongodb",
        ...
        category: "Full-Stack Apps",
        problem:
            "B2B marketplaces typically force all users into a single experience, ignoring the fundamentally different needs of individual buyers vs. company purchasing departments.",
        solution:
            "Built a dual-portal B2B marketplace with separate authentication flows and interfaces for individual users and companies, each tailored to their procurement workflows.",
        results: [
...

    {
        ...
        slug: "elygance",
        description:
            "A luxury e-commerce platform for premium fragrances with elegant design and seamless shopping experience.",
        ...
        category: "Full-Stack Apps",
        problem:
            "A premium fragrance brand needed an e-commerce experience that reflects their luxury positioning - generic storefronts undermine the perception of exclusivity and quality.",
        solution:
            "Designed a luxury e-commerce platform with elegant typography, refined spacing, a sophisticated color palette, and a frictionless checkout experience.",
        results: [
