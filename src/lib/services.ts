...
export const services: ServiceType[] = [
    {
        ...
        content:
            "End-to-end modern web applications with seamless frontend-backend integration and high performance.",
        points: [
    ...
    },
    {
        ...
        content:
            "Custom software solutions tailored to solve complex business problems with clean, maintainable code.",
        points: [
    ...
    },
    {
        ...
        content:
            "Secure, scalable, and high-performance backend systems built for reliability and speed.",
        points: [
    ...
    },
    {
        ...
        content:
            "Rapid development and deployment of SaaS MVPs to help you launch and validate your business ideas quickly.",
        points: [
