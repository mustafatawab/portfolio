  ...
  if (!blogs) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-neon-cyan font-mono animate-pulse uppercase tracking-widest">Synchronizing Feed...</div>
      </div>
    );
  }
            ...
            return (
              ...
              >
                <Link href={`/blogs/${blog.fields.slug}`} className="group block h-full">
                  <div className="glass-card h-full rounded-[2rem] overflow-hidden border-border hover:neon-glow-cyan transition-all duration-500 flex flex-col">
                    <div className="relative aspect-video overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 flex gap-2">
                        <Badge className="bg-background/50 backdrop-blur-md border-border text-[9px] font-mono tracking-widest text-neon-cyan">
                          SEGMENT 0{index + 1}
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div className="p-8 flex flex-col flex-1 space-y-6">
                      <div className="space-y-4 flex-1">
                        ...
                        <h2 className="text-2xl font-bold leading-tight group-hover:text-neon-cyan transition-colors text-foreground uppercase tracking-tight">
                          {blog.fields.title}
                        </h2>
