          ...
          <div className="flex-1 min-w-0 max-w-3xl">
            ...
            {s.techDecisions.length > 0 && (
              <Section id="technology-decisions">
                <SectionHeading>Technology Decisions</SectionHeading>
                <div className="space-y-4">
                  {s.techDecisions.map((d, i) => (
                    <TechDecisionCard key={i} decision={d} />
                  ))}
                </div>
              </Section>
            )}
            ...
            {related.length > 0 && (
              <Section id="related" className="border-t border-border pt-12">
            ...
            {/* ── CTA ── */}
            <Section id="cta" className="border-t border-border pt-12">
