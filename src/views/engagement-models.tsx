...
const models = [
    ...
    },
    {
        ...
        cta: {
            ...
            href: "/case-studies/navpoint-health",
        },
    },
    {
        icon: Handshake,
        ...
        <section id="engagement" className="py-24 md:py-32 bg-background">
            <div className="container">
                ...
                >
                    ...
                    >
                        Every project is different. Whether you need a quick
                        discovery session or a long-term engineering
                        partnership, there is a model that fits.
                    </motion.p>
                </motion.div>
