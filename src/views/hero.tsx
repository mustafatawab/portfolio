            ...
            <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        >
                            Building modern{" "}
                            <span className="text-primary">software</span> that{" "}
                            <span className="text-primary">solves</span> real
                            business problems.
                        </motion.h1>
                        ...
                        >
                            I design and build custom web applications, SaaS
                            platforms, and backend systems - from concept to
                            production.
                        </motion.p>
