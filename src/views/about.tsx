        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <Image
              ...
              fill
              alt="Mustafa Tawab"
              className="rounded-2xl object-cover transition-all duration-700 brightness-110 dark:brightness-100"
            />
          ...
          <div className="flex-1 space-y-12">
            ...
            >
              ...
              <p className="text-foreground/80 text-lg md:text-xl leading-relaxed max-w-2xl">
                I'm a dedicated <span className="text-foreground font-semibold italic text-mono">Senior Full Stack Engineer</span> with over 
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-foreground/40 italic font-mono text-sm border-l-2 border-neon-purple pl-6 py-2"
            >
