        ...
        if (search.trim()) {
            ...
            list = list.filter(
                (p) =>
                    ...
                    p.techStack.frontend.some((t) =>
                        t.toLowerCase().includes(q)
                    ) ||
                    p.techStack.backend.some((t) =>
                        t.toLowerCase().includes(q)
                    ) ||
                    p.techStack.database.some((t) =>
                        t.toLowerCase().includes(q)
                    )
            )
        }
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed mt-4 max-w-2xl">
                            A catalog of SaaS platforms, business applications,
                            desktop software, and enterprise solutions I have
